...
const AssignmentsCard = ({assignment}) => {
    ...
    const {assignmentTitle, marks, difficultyLevel, image} = assignment
    return (
        <div className="max-w-7xl mx-auto my-12">
            <div className=" card w-96 shadow-xl p-2 border-2 border-gray-300 bg-stone-100">
                <div className=""><img className="rounded-md shadow-lg" src={image} alt="Shoes" /></div>
                <div className="card-body flex flex-col gap-5">
                    <h2 className="card-title">{assignmentTitle}</h2>
                    <hr className="border-gray-300" />
                    <div className="flex flex-col">
                        <p className="text-gray-500">Marks: {marks} </p>
                        <p className="text-gray-500">Difficulty Level: {difficultyLevel}</p>
                    </div>
                    <hr className="border-gray-300" />
