    ...
    return (
        <div className="max-w-7xl mx-auto space-y-10">
            <div className="text-center space-y-4">
                ...
                <p className="text-2xl font-medium">Empowering Collaborative Learning: Explore Our Key Features</p>
            </div>
            <div className="max-w-sm bg-white border-2 border-fuchsia-600 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-2xl">
                <a href="#">
