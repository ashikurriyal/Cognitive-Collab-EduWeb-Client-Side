        ...
        <div className='max-w-7xl mx-auto flex items-center'>
            <div className='w-1/2 flex flex-col gap-12'>
                <div className='flex flex-col gap-6'>
                    <h1 className='text-black text-5xl font-bold'>Cognitive <span className='text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-800  to-pink-600'>Collab</span></h1>
